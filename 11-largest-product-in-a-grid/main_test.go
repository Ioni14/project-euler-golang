...
func TestNaive(t *testing.T) {
	...
	res, _ := naive(Horizontal | Vertical | DiagonalLeft | DiagonalRight, 4, grid, 20, 20)
	if res != 70600674 {
		t.Errorf("naive(Horizontal | Vertical | DiagonalLeft | DiagonalRight, 4, grid, 20, 20) must be 70600674. res=%v", res)
	}
}
